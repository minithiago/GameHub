                    ...
                    StreamBuilder<SwitchItem>(
                      ...
                      builder: (BuildContext context,
                        ...
                        switch (snapshot.data) {
                          ...
                          default:
                            // Aquí deberías manejar el caso predeterminado si es necesario
                            return Container(); // O cualquier otro widget predeterminado
                        }
                      },
                    )
                  ],
                  ...
                  child: StreamBuilder<SwitchItem>(
                    ...
                    builder: (BuildContext context,
                      ...
                      switch (snapshot.data) {
                        ...
                        default:
                          // Maneja el caso predeterminado si es necesario
                          return Container(); // O cualquier otro widget predeterminado
                      }
                    },
                  ),
